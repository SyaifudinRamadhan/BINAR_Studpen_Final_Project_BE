...
const whoAmI = () => api.get('/api/v1/who-am-i').set('x-access-token', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiZDk0MDcyZDktMDg2Yy00MjlmLTg0MmMtMjdkMDg0NGVlODExIiwiaWF0IjoxNjcyMjc5Njc5fQ.2pO20pta3-JIygEHaVT2XSitVTIO4KKAIgUAB83UaxE').set('Accept', 'application/json')
...
describe('Endpoint login', () => {
    test('Endpoint login berstatus 200', async () => {
        ...
        expect(response.body).toEqual(bodyRes)
    })
})